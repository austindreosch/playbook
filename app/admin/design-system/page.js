    ...
    <div className="min-h-screen bg-bg-white-0 p-8">
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="text-center">
          <h1 className="text-title-h1 text-strong-950 mb-4">Design System Showcase</h1>
          <p className="text-paragraph-lg text-sub-600">Typography and Color Palette Reference</p>
        </div>

        {/* Typography Section */}
        <section className="space-y-8">
          <h2 className="text-title-h2 text-strong-950 border-b border-stroke-soft-200 pb-4">Typography System</h2>
          
          {Object.entries(textCategories).map(([category, sizes]) => (
            <div key={category} className="space-y-4">
              <h3 className="text-title-h4 text-sub-600">{category}</h3>
                  ...
                  return (
                    <div key={size} className="flex items-center gap-8 p-4 bg-bg-weak-50 rounded-lg border border-stroke-soft-200">
                      <div className="min-w-32">
                        <code className="text-subheading-sm text-sub-600">{size}</code>
                      </div>
                      <div className={`text-${size} text-strong-950 flex-1`}>
                        The quick brown fox jumps over the lazy dog
                      </div>
                      <div className="text-paragraph-sm text-soft-400 space-y-1 min-w-48">
        ...
        <section className="space-y-8">
          <h2 className="text-title-h2 text-strong-950 border-b border-stroke-soft-200 pb-4">Color Palette</h2>
          
          {Object.entries(colorCategories).map(([category, shades]) => (
            <div key={category} className="space-y-4">
              <h3 className="text-title-h4 text-sub-600 capitalize">{category.replace('_', ' ')}</h3>
                  ...
                  return (
                    <div key={shade} className="space-y-2">
                      ...
                      <div className="space-y-1">
                        <div className="text-subheading-xs text-strong-950 font-medium">{shade}</div>
                        <div className="text-subheading-2xs text-soft-400 font-mono">{colorClass}</div>
        ...
        <section className="space-y-8">
          <h2 className="text-title-h2 text-strong-950 border-b border-stroke-soft-200 pb-4">CSS Variables Reference</h2>
          <div className="bg-bg-weak-50 rounded-lg p-6 border border-stroke-soft-200">
            <p className="text-paragraph-md text-sub-600 mb-4">
              All colors use CSS custom properties. For example:
            </p>
            <div className="space-y-2 text-subheading-sm font-mono">
              <div className="text-strong-950">--neutral-500: 107 114 128;</div>
              <div className="text-strong-950">--primary-base: 59 130 246;</div>
              <div className="text-strong-950">--bg-white-0: 255 255 255;</div>
              <div className="text-strong-950">--text-strong-950: 3 7 18;</div>
            </div>
          </div>
        </section>
      </div>
