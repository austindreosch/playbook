...
export const SPORT_CONFIGS = {
    ...
    nfl: {
        ...
        statPathMapping: { // Updated NFL mapping to RAW paths
            ...
            'PS%': '', // Find in derivedStatDefinitions
            'TD%': '', // Find in derivedStatDefinitions
        ...
        derivedStatDefinitions: {
            ...
            'PPG0ppr': {
                ...
                calculationKey: 'calculateNflPpg0ppr' // Reference implementation
            },
            'PPG0.5ppr': {
                label: 'Fantasy Points Per Game (0.5 PPR)',
                 ...
                 calculationKey: 'calculateNflPpgHalfPpr' // Reference implementation
            },
            'PPG1ppr': {
                label: 'Fantasy Points Per Game (1 PPR)',
                requiredStats: ['GP', 'passYds', 'passTD', 'interceptions', 'rushYds', 'rushTD', 'rec', 'recYds', 'recTD', 'fumLost'],
                calculationKey: 'calculateNflPpgFullPpr' // Reference implementation
            },
            ...
            'OPE': {
                 ...
                 calculationKey: 'calculateNflOpe' // Reference implementation (will use 1 PPR calculation)
            },
             // --- Rates & Shares ---
            'YD%': {
                label: 'Yard Share %',
            ...
            'PS%': {
                ...
                // NOTE: Implementation needs team totals and specific definition context
                calculationKey: 'calculateNflProductionShare',
                needsContext: ['teamTotals', 'definitionContext'] // Indicate external data/logic needed
            },
            'TD%': {
