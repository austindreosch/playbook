    ...
    mlb: {
        ...
        categories: {
            ...
            'PPG': { 
                ...
                statDisplay: {
                    decimals: 2,
                    trimTrailingZeros: false, // Ensures 2.40 stays 2.40, not 2.4
                    showLeadingZero: true     // Ensures 0.90 stays 0.90, not .90
                }
            }, 
            // ---------------------
            //        Hitting
    ...
    nfl: {
        ...
        categories: {
            ...
            'OPE': { 
                ...
                enabled: true, 
                tooltip: 'Fantasy Points / (Pass Att + Rush Att + Targets). Higher values indicate better efficiency with each opportunity/touch.',
                ptsEnabled: true, 
                showInPointsView: true,
                zscoreColorMin: -2.0,  // Reaches full red at -0.8 z-score
                zscoreColorMax: 2.0,
            ...
            'YPS': { // YARDS PER SNAP
                label: 'Yards Per Snap',
                enabled: true,
                tooltip: 'Total Yards / Total Snaps. Higher values indicate better efficiency in generating yardage on a per-snap basis.',
                ptsEnabled: true,
                showInPointsView: true, // Assuming you want to see this in points views too
                zscoreColorMin: -2.0, 
                zscoreColorMax: 2.0,
                statDisplay: {
                    decimals: 2, // e.g., 1.75 Yards/Snap
            ...
            'YD%': { 
                label: 'Yard Share', 
                enabled: true, 
                tooltip: 'Total Yards / Team Totals. Higher values indicate a greater share of actual yardage gained, reflecting a player’s output contribution to the team.',
                ptsEnabled: true, 
                showInPointsView: true,
                zscoreColorMin: -2.0,  // Reaches full red at -0.8 z-score
                zscoreColorMax: 2.0,   // Reaches full green at 0.8 z-score
            ...
            'PR%': { 
                ...
                enabled: true, 
                tooltip: "(Pass Comp + Rush Att + Receptions) / Team Totals. Higher share indicates consistent involvement in the team’s successful offensive plays.",
                ptsEnabled: true, 
                showInPointsView: true,
                zscoreColorMin: -2.0,  // Reaches full red at -0.8 z-score
                zscoreColorMax: 2.0,   // Reaches full green at 0.8 z-score
        ...
        statPathMapping: { // Updated NFL mapping to RAW paths
            ...
            // General
            'GP': 'stats.gamesPlayed',
            'offenseSnaps': 'stats.snapCounts.offenseSnaps',
        ...
        derivedStatDefinitions: {
            ...
            'YPS': { // YARDS PER SNAP
                label: 'Yards Per Snap',
                requiredStats: ['passYds', 'rushYds', 'recYds', 'offenseSnaps'],
                calculationKey: 'calculateNflYardsPerSnap',
                format: 'float2', // Matches statDisplay.decimals
                category: 'Efficiency',
                positive: true,
                higherIsBetter: true
            },
...
export const ZSCORE_COLOR_CONFIG = {
    ...
    colors: {
        ...
        neutral: [255, 255, 255],    // Lighter than gray-50
        fallback: [243, 244, 246],   // 
    },
...
export const MANUAL_STAT_OVERRIDES = [
    {
        sport: 'nfl', 
        mySportsFeedsId: '133835', // Caleb Williams
        targetSeason: '2024-2025-regular', // Ensure this is correctly placed
        statOverrides: {
            'snapCounts.offenseSnaps': 1123 // << This is where you put the corrected number            
        }
    },
    {
        sport: 'nfl', 
        mySportsFeedsId: '39186', // Sam Howell
        targetSeason: '2024-2025-regular', // Ensure this is correctly placed
        statOverrides: {
            'snapCounts.offenseSnaps': 26 // << This is where you put the corrected number            
        }
    },
    // Example for another season or player:
    // {
    //     sport: 'nfl', 
    //     mySportsFeedsId: 'SOME_OTHER_ID',
    //     targetSeason: '2023-2024-regular', 
    //     statOverrides: {
    //         'some.other.stat': 0 
    //     }
    // },
