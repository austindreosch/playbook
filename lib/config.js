    ...
    nba: { 
        ...
        categories: { 
            ...
            'PPG': { 
                ...
                zScoreThreshold: 2.0  // 2 points difference is significant
            }, 
            // Standard
            'FG%': { 
                ...
                zscoreColorMin: -0.8,  // Reaches full red at -0.8 z-score
                zscoreColorMax: 0.8,   // Reaches full green at 0.8 z-score
                isPercentage: true
            },
            'FT%': { 
            ...
            '3PM': { 
                ...
                zscoreColorMin: -1.2,  // Reaches full red at -1.2 z-score
                zscoreColorMax: 1.2    // Reaches full green at 1.2 z-score
            },
            'PTS': { 
    ...
    mlb: {
        ...
        categories: {
            ...
            'R': { 
                ...
                zscoreColorMin: -2.5,  // Reaches full red at -2.5 z-score
                zscoreColorMax: 2.5    // Reaches full green at 2.5 z-score
            },
            'HR': { 
                label: 'Home Runs', 
                enabled: true, 
                ...
                zscoreColorMin: -1.0,  // Reaches full red at -1.0 z-score
                zscoreColorMax: 1.0    // Reaches full green at 1.0 z-score
            },
            'RBI': { 
            ...
            'H': { 
                ...
                showInPointsView: false, 
                tooltip: 'Total hits',
                zScoreThreshold: 10.0  // 10 hits difference is significant
            },
            '2B': { 
                label: 'Doubles', 
                enabled: false, 
                ...
                zScoreThreshold: 3.0  // 3 doubles difference is significant
            },
            '3B': { 
                label: 'Triples', 
                enabled: false, 
                ...
                zScoreThreshold: 1.0  // 1 triple difference is significant
            },
            'OBP': { 
                ...
                zScoreThreshold: 0.02,  // 0.02 (20 points) difference is significant
                isPercentage: true
            },
            'SLG': { 
                ...
                zScoreThreshold: 0.03,  // 0.03 (30 points) difference is significant
                isPercentage: true
            },
            'OPS': { 
                ...
                zScoreThreshold: 0.05,  // 0.05 (50 points) difference is significant
                isPercentage: true
            },
            'TB': { 
                label: 'Total Bases', 
                ...
                zScoreThreshold: 15.0  // 15 total bases difference is significant
            },
            // ---------------------
            //       Pitching
            // ---------------------
            ...
            'QS': { 
                ...
                zScoreThreshold: 2.0  // 2 QS difference is significant
            },
            'SVH': { 
                label: 'Saves + Holds', 
                enabled: false, 
                ...
                zScoreThreshold: 4.0  // 4 SV+H difference is significant
            },
            'HLD': { 
                label: 'Holds', 
                enabled: false, 
                ...
                showInPointsView: false, 
                tooltip: 'Total holds',
                zScoreThreshold: 3.0  // 3 holds difference is significant
            },
            'K/BB': { 
                ...
                zScoreThreshold: 0.5  // 0.5 K/BB difference is significant
            },
            'K/9': { 
                ...
                zScoreThreshold: 1.0  // 1.0 K/9 difference is significant
            },
            'IP': { 
                ...
                zScoreThreshold: 10.0  // 10 IP difference is significant
            },
        },
        statPathMapping: { 
