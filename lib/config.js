...
export const SPORT_CONFIGS = {
    ...
    nfl: {
        ...
        comparisonPools: {
            // Both formats use positional comparison based on Redraft ECR
            // (Assuming category leagues also use this, adjust if needed)
            categories: { // Added for completeness, assuming same rules as points
                type: 'positional',
                groups: {
                 ...
                 // Simple grouper based on primaryPosition (case-insensitive)
