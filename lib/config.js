...
export const SPORT_CONFIGS = {
    nba: { 
        ...
        categories: { 
            ...
            'PPG': { label: 'Fantasy Points Per Game', enabled: false, ptsEnabled: true, showInPointsView: true, tooltip: 'Total fantasy points scored per game' }, 
            // Standard
            'FG%': { label: 'Field Goal Percentage', enabled: true, ptsEnabled: false, showInPointsView: false, tooltip: 'Percentage of field goals made' },
            'FT%': { label: 'Free Throw Percentage', enabled: true, ptsEnabled: false, showInPointsView: false, tooltip: 'Percentage of free throws made' },
            '3PM': { label: '3-Pointers Made Per Game', enabled: true, ptsEnabled: false, showInPointsView: false, tooltip: 'Average number of 3-pointers made per game' },
            'PTS': { label: 'Points Per Game', enabled: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Average points scored per game' },
            'REB': { label: 'Rebounds Per Game', enabled: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Average rebounds per game' },
            'AST': { label: 'Assists Per Game', enabled: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Average assists per game' },
            'STL': { label: 'Steals Per Game', enabled: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Average steals per game' },
            'BLK': { label: 'Blocks Per Game', enabled: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Average blocks per game' },
            'TO': { label: 'Turnovers', enabled: true, lowerIsBetter: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Average turnovers per game' },
            // Alternative
    ...
    mlb: {
        ...
        categories: {
            ...
            // ---------------------
            // Standard 5x5 
            'R': { label: 'Runs', enabled: true, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Total runs scored' },
            'HR': { label: 'Home Runs', enabled: true, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Total home runs hit' },
            'RBI': { label: 'Runs Batted In', enabled: true, group: 'hitting', ptsEnabled: true, showInPointsView: true, tooltip: 'Total runs batted in' },
            'SB': { label: 'Stolen Bases', enabled: true, group: 'hitting', ptsEnabled: true, showInPointsView: true, tooltip: 'Total stolen bases' },
            'AVG': { label: 'Batting Average', enabled: true, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Hits divided by at-bats' },
            // Alternative Hitting
            'H': { label: 'Hits', enabled: false, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Total hits' },
            '2B': { label: 'Doubles', enabled: false, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Total doubles hit' },
            '3B': { label: 'Triples', enabled: false, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Total triples hit' },
            'OBP': { label: 'On-Base Percentage', enabled: false, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Times on base divided by plate appearances' },
            'SLG': { label: 'Slugging Percentage', enabled: false, group: 'hitting', ptsEnabled: false, showInPointsView: false, tooltip: 'Total bases divided by at-bats' },
            'OPS': { label: 'On-Base + Slugging', enabled: false, group: 'hitting', ptsEnabled: true, showInPointsView: true, tooltip: 'On-base percentage plus slugging percentage' },
            'TB': { label: 'Total Bases', enabled: false, group: 'hitting', ptsEnabled: true, showInPointsView: true, tooltip: 'Total bases from hits' },
            // ---------------------
            //       Pitching
            // ---------------------
            // Standard 5x5
            'W': { label: 'Wins', enabled: true, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Total wins' },
            'K': { label: 'Strikeouts', enabled: true, group: 'pitching', ptsEnabled: true, showInPointsView: true, tooltip: 'Total strikeouts' },
            'SV': { label: 'Saves', enabled: true, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Total saves' },
            'ERA': { label: 'Earned Run Average', enabled: true, group: 'pitching', lowerIsBetter: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Earned runs allowed per 9 innings' },
            'WHIP': { label: 'Walks + Hits per IP', enabled: true, group: 'pitching', lowerIsBetter: true, ptsEnabled: true, showInPointsView: true, tooltip: 'Walks and hits allowed per inning pitched' },
            // Alternative Pitching
            'QS': { label: 'Quality Starts', enabled: false, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Starts with 6+ IP and 3 or fewer earned runs' },
            'SVH': { label: 'Saves + Holds', enabled: false, group: 'pitching', ptsEnabled: true, showInPointsView: true, tooltip: 'Total saves plus holds' },
            'HLD': { label: 'Holds', enabled: false, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Total holds' },
            'K/BB': { label: 'Strikeout/Walk Ratio', enabled: false, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Strikeouts divided by walks' },
            'K/9': { label: 'Strikeouts per 9 IP', enabled: false, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Strikeouts per 9 innings pitched' },
            'IP': { label: 'Innings Pitched', enabled: false, group: 'pitching', ptsEnabled: false, showInPointsView: false, tooltip: 'Total innings pitched' },
