...
export const calculatePlayerZScoreSums = (
    ...
    statPathMapping,
    sport,
    format = 'redraft',          // Default format
    scoringType = 'categories',   // Default scoring type
    pprSetting = '0ppr',          // Default NFL PPR setting
    flexSetting = 'standard'      // Default NFL flex setting
) => {
