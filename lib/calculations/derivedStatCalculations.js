...
export function calculateNflYardShare(playerStats, context) {
    ...
    const teamRecYds = teamTotals.recYds || 0; // Example - team may not have receiving yards total directly
    const teamTotalYds = teamPassYds + teamRushYds; // Adjust if team RecYds available
