...
export const TRAIT_METADATA = {
  ...
  // Team-level traits
  heavy_punt: { icon: Shield, label: 'Heavy Punt', tooltip: 'Team is punting on this season to build for the future.' },
  contending: { icon: Crown, label: 'Contending', tooltip: 'Team is well-positioned to compete for a championship.' },
  aging: { icon: Clock, label: 'Aging', tooltip: 'Team has an older roster that may decline soon.' },
  poor_playoff_schedule: { icon: XCircle, label: 'Poor Playoff Schedule', tooltip: 'Team faces difficult matchups during playoff weeks.' },
  injured_team: { icon: Bandage, label: 'Injured Team', tooltip: 'Team has multiple players dealing with injuries.' },
};
