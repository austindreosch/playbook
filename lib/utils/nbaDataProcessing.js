...
export function processNbaData(rawPlayerStatsTotals = [], context = {}) {
    ...
    for (const playerAggData of Object.values(aggregatedPlayers)) {
        ...
        if (!identityData) {
            ...
            // console.log(`[processNbaData] Identity data FOUND using key (msfId): ${playerId}. Contains playbookId: ${identityData.playbookId}`);
        }
        ...
        // <<< Log Final playbookId >>>
        console.log(`[processNbaData] Final playerInfo.playbookId assigned: ${playerInfo.playbookId} (was: ${originalPlaybookIdBeforeAssign}, from FOUND identity.playbookId: ${identityData?.playbookId})`);
        // <<< End Log >>>
