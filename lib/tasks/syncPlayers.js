            ...
            try {
                ...
                for (const playerEntry of msfPlayerEntries) {
                    ...
                    if (existingById) {
                        ...
                        if (existingByName) {
                            let manuallyBlocked = false; // Flag to indicate if a manual block rule was applied
                            ...
                            for (const rule of PLAYER_SYNC_MANUAL_BLOCKS) {
                                ...
                                if (sourcePlayerMatchesRule && targetDocumentMatchesRule) {
                                    ...
                                    break; // Rule applied, no need to check other rules
                                }
                            }
                            // <<< END GENERALIZED MANUAL BLOCK LOGIC >>>

                            if (!manuallyBlocked) {
                                // Original logic follows if not manually blocked
