...
export const custom = {
  ...
  // 'big': ['1.125rem', { lineHeight: '1.5rem', letterSpacing: '0em', fontWeight: '700', color: 'var(--black)' }],
  // 'header': ['0.984375rem', { lineHeight: '1.3125rem', letterSpacing: '-0.015em', fontWeight: '550', color: 'var(--black)' }],
  // 'label': ['0.84375rem', { lineHeight: '1.125rem', letterSpacing: '-0.01em', fontWeight: '550', color: 'var(--black)' }],
  // 'number': ['0.84375rem', { lineHeight: '1.125rem', letterSpacing: '0em', fontWeight: '600', fontVariantNumeric: 'tabular-nums', color: 'var(--black)' }],
  // 'paragraph': ['0.7875rem', { lineHeight: '1.125rem', letterSpacing: '-0.005em', fontWeight: '400', color: 'var(--gray-400)' }],
  // 'badge': ['0.75rem', { lineHeight: '1.125rem', letterSpacing: '-0.0085em', fontWeight: '550', color: 'var(--black)' }],
  // 'sublabel': ['0.6875rem', { lineHeight: '1.03125rem', letterSpacing: '-0.005em', fontWeight: '400', color: 'var(--gray-300)' }],
  // 'tight': ['0.5625rem', { lineHeight: '0.75rem', letterSpacing: '-0.006em', fontWeight: '400', color: 'var(--gray-300)' }],
