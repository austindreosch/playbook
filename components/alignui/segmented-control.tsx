...
>(({ children, className, floatingBgClassName, ...rest }, forwardedRef) => {
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cnExt(
        'relative isolate grid w-full auto-cols-fr grid-flow-col gap-1 rounded-10 bg-bg-weak-10 p-1',
        className,
      )}
      {...rest}
    >
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cnExt(
        // base
        'peer',
        'relative z-10 h-6 whitespace-nowrap rounded-md px-1 text- text-text-soft-400 outline-none',
