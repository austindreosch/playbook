...
export default function TradeOutcomeBlock() {
  ...
  return (
    <div className="w-full h-full border border-pb_lightgray rounded-lg overflow-hidden">
      
      {/* Card Header */}
      <div className="bg-pb_backgroundgray p-3 flex items-center justify-between border-b border-pb_lightgray">
