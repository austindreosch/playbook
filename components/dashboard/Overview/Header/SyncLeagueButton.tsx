  ...
  return (
    <button
      ...
      className={`flex items-center justify-between h-9 min-h-9 w-24 rounded-lg px-2.5 shadow-regular-xs transition-colors duration-200 focus:shadow-button-important-focus focus:outline-none select-none ${
        isLoading
          ? 'bg-gradient-to-r from-pb_green-700 via-pb_green-500 to-pb_green-700 bg-[length:300%_100%] animate-background-pan-slow border-pb_green-700 ring-1 ring-pb_green-700'
          : isSuccess
          ? 'bg-pb_green ring-1 ring-pb_green-700'
