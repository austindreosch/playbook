...
export default function RosterViewImportLeague() {
  return (
    <div className="w-full h-full bg-pb_backgroundgray border-1.5 border-pb_lightgray rounded-lg shadow-sm shadow-inner flex flex-col items-center justify-center p-4 text-center select-none">
