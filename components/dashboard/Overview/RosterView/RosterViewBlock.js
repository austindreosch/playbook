...
import { AlertTriangle, Compass, FileText, FileUp, Heart, Maximize2, Plus, SlidersHorizontal, Snowflake, SigmaSquare, Target, TrendingDown, TrendingUp, Wrench } from 'lucide-react';
...
export default function RosterViewImportLeague() {
  ...
  const players = [
    ...
    { playbookScore: 910, name: 'Jayson Tatum', position: 'PF', value: 4.60, icon: AlertTriangle, iconColor: 'text-red-500' },
    { playbookScore: 890, name: 'Cade Cunningham', position: 'PG', value: 2.80 },
    { playbookScore: 870, name: 'LaMelo Ball', position: 'PG', value: 2.24, icon: Heart, iconColor: 'text-gray-700' },
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden">
      {/* Header */}
      <div className="bg-black text-white px-2 py-2 flex items-center justify-between rounded-lg flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* <Maximize2 className="hw-icon-sm" /> */}
          {/* <Compass className="hw-icon-sm" /> */}
        </div>
      </div>
