      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mb-2 flex-shrink-0">
        ...
        <div className="flex flex-row gap-2 w-full mt-3">
          ...
          <div className="w-full space-y-3.5">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-label-lg font-medium text-gray-200">Standard</span>
              </div>
              <span className="text-paragraph-md font-medium font-mono text-gray-200">13.25</span>
            </div>
          </div>
          ...
          {/* <div className=' w-full flex justify-center'>
            ...
            <div className='flex flex-col text-center w-1/2 gap-1.5'> 
              <div className="flex items-center gap-0.5 text-subheading-lg mdh:text-title-h6 font-medium text-error-base">
                <FillArrowDown className="hw-icon-xs mdh:hw-icon-sm" />
                2%
              </div>
              <div className='text-paragraph-xs text-gray-300 leading-tighter'>
